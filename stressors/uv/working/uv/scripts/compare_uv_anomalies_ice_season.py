...
uv_anomaly_input_dir = r"E:\\uv\\uv_baseline_anomaly_ice_season"
uv_anomaly_output_dir = r"E:\\uv\\uv_baseline_anomaly_ice_season"

# anomaly input rasters (from input directory above)
anomaly_rast1_raw="toms_ep_uv_anomaly_1997-2001-ice_season.tif"
anomaly_rast2_raw="omi_aura_uv_anomaly_2008-2012-ice_season.tif"

# output raster names
anomaly_rast1_trans="toms_ep_uv_anomaly_1997-2001-ice_season_trans.tif"
anomaly_rast2_trans="omi_aura_uv_anomaly_2008-2012-ice_season_trans.tif"

difference_rast_raw_output='uv_anomaly_difference_ice_season_raw.tif'
difference_rast_trans_output='uv_anomaly_difference_ice_season_trans.tif'
