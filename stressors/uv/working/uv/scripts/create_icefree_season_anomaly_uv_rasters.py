...
uv_rast_input={
 'toms_ep':{
 'dir': '/var/cache/halpern-et-al/mnt/storage/marine_threats/impact_layers_2013_redo/impact_layers/work/uv/uv_monthly_mean/',
 'file_type': '.tif',
 'raster_prefix': 'toms_ep_uv_mean_',
 'year_start': 1997,
 'year_end': 2001,
 'month_list': [6,7,8,9,10],
 'season': 'ice_free_season'},
 'omi_aura':{
 'dir': '/var/cache/halpern-et-al/mnt/storage/marine_threats/impact_layers_2013_redo/impact_layers/work/uv/uv_monthly_mean/',
 'file_type':'.tif',
...
uv_rast_output_dir='/var/cache/halpern-et-al/mnt/storage/marine_threats/impact_layers_2013_redo/impact_layers/work/uv/uv_baseline_anomaly_icefree_season'
...
for sat_name in uv_rast_input:
  ...
  for year in range(uv_rast_input[sat_name]['year_start'],uv_rast_input[sat_name]['year_end']+1):
    ...
    for month in uv_rast_input[sat_name]['month_list']:
...
for sat_name in uv_rast_input:
  ...
  str(uv_rast_input[sat_name]['year_start'])+'-'+\
  str(uv_rast_input[sat_name]['year_end'])+'-'+\
  str(uv_rast_input[sat_name]['season'])+'.tif'),+\
