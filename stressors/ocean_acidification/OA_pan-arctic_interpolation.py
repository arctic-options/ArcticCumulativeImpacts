...
output_raster_dir = r'A:\HIACMS\CHI\stressors\ocean_acidification\pan-arctic\annual_oa_rescaled_1km_int'
...
rasters = glob.glob('A:/HIACMS/CHI/stressors/ocean_acidification/pan-arctic/annual_oa_rescaled_1km/*.tif') 
