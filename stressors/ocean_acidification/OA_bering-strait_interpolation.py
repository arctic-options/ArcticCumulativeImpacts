...
feature_dir = r'A:\HIACMS\CHI\stressors\ocean_acidification' #feature directory is where Arc considers the 'home' for this script
# the r above means treat the following as a raw string (don't escape the backslashes)
output_raster_dir = r'A:\HIACMS\CHI\stressors\ocean_acidification\bering-strait\annual_oa_rescaled_1km_int'
...
rasters = glob.glob('A:/HIACMS/CHI/stressors/ocean_acidification/bering-strait/annual_oa_rescaled_1km/*.tif') 
