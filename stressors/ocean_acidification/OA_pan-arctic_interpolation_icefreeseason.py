...
feature_dir = r'C:\Users\Afflerbach\Documents\GitHub\CumulativeImpacts\stressors\ocean_acidification' #feature directory is where Arc considers the 'home' for this script
# the r above means treat the following as a raw string (don't escape the backslashes)
output_raster_dir = r'C:\Users\Afflerbach\Documents\GitHub\CumulativeImpacts\stressors\ocean_acidification\working\pan-arctic\icefree_season\rescaled_1km_int'
...
rasters = glob.glob('C:/Users/Afflerbach/Documents/GitHub/CumulativeImpacts/stressors/ocean_acidification/working/pan-arctic/icefree_season/rescaled_1km/*.tif') 
